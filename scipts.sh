...
nohup python run_adaptive.py --dataset 'cora' --model 'GCN' --test_model 'GCN' --defense_mode 'none' --device_id 5 --homo_loss_weight 1 > ./logs/unno_cora_atk_gcn2gcn.log 2>&1 &
nohup python run_adaptive.py --dataset 'cora' --model 'GCN' --test_model 'GCN' --defense_mode 'prune' --device_id 5 --homo_loss_weight 1 --prune_thr 0.15 > ./logs/unno_cora_pru_gcn2gcn_pr015.log 2>&1 &
nohup python run_adaptive.py --dataset 'cora' --model 'GCN' --test_model 'GCN' --defense_mode 'isolate' --device_id 5 --homo_loss_weight 1 --prune_thr 0.15 > ./logs/unno_cora_iso_gcn2gcn_pr015.log 2>&1 &
