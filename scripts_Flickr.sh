...
## Defend: None
nohup python run_adaptive.py --dataset 'Flickr' --train_lr 0.02 --hidden 64 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 5 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 1 --evaluate_mode "overall" > ./logs/Flickr/Flickr_Unno_None_gcn2gcn_clu_vs5.log 2>&1 &
nohup python run_adaptive.py --dataset 'Flickr' --train_lr 0.02 --hidden 64 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 2 --evaluate_mode "overall" > ./logs/Flickr/Flickr_Unno_None_gcn2gcn_vs10.log 2>&1 &
nohup python run_adaptive.py --dataset 'Flickr' --train_lr 0.02 --hidden 64 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 20 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 3 --evaluate_mode "overall" > ./logs/Flickr/Flickr_Unno_None_gcn2gcn_vs20.log 2>&1 &
nohup python run_adaptive.py --dataset 'Flickr' --train_lr 0.02 --hidden 64 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 40 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 0 --evaluate_mode "overall" > ./logs/Flickr/Flickr_Unno_None_gcn2gcn_vs40.log 2>&1 &
nohup python run_adaptive.py --dataset 'Flickr' --train_lr 0.02 --hidden 64 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 80 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 2 --evaluate_mode "overall" > ./logs/Flickr/Flickr_Unno_None_gcn2gcn_vs80.log 2>&1 &
## Defend: Prune
