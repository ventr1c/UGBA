...
# Attack: Ours
## Defend: None
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 160 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'cluster_degree' --device_id 1 > ./logs/Arxiv/Arxiv_Ours_None_gcn2gcn_vs160.log 2>&1 &


# Attack: Without Selection
## Defend: None
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 80 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'none' --device_id 0 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs80.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 160 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'none' --device_id 0 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs160.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 240 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'none' --device_id 0 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs240.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 320 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'none' --device_id 0 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs320.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 400 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --attack_method 'Basic' --defense_mode 'none'  --dis_weight 1 --selection_method 'none' --device_id 2 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs400.log 2>&1 &

## Defend: Prune
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 80 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 80 --attack_method 'Basic' --defense_mode 'prune'  --dis_weight 1 --selection_method 'none' --device_id 1 > ./logs/Arxiv/Arxiv_Unno_Prune_gcn2gcn_vs80.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 160 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 160 --attack_method 'Basic' --defense_mode 'prune'  --dis_weight 1 --selection_method 'none' --device_id 1 > ./logs/Arxiv/Arxiv_Unno_Prune_gcn2gcn_vs160.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 240 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 160 --attack_method 'Basic' --defense_mode 'prune'  --dis_weight 1 --selection_method 'none' --device_id 2 > ./logs/Arxiv/Arxiv_Unno_Prune_gcn2gcn_vs160.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 320 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 160 --attack_method 'Basic' --defense_mode 'prune'  --dis_weight 1 --selection_method 'none' --device_id 2 > ./logs/Arxiv/Arxiv_Unno_Prune_gcn2gcn_vs160.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --use_vs_number --vs_number 400 --prune_thr 0.8 --homo_loss_weight 100 --homo_boost_thrd 0.8 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 160 --attack_method 'Basic' --defense_mode 'prune'  --dis_weight 1 --selection_method 'none' --device_id 3 > ./logs/Arxiv/Arxiv_Unno_Prune_gcn2gcn_vs160.log 2>&1 &