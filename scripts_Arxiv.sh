...
# Attack: Without Selection
## Defend: None
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --train_lr 0.02 --hidden 64 --vs_ratio 0.001 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 80 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 0 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs80.log 2>&1 &
nohup python run_adaptive.py --dataset 'ogbn-arxiv' --train_lr 0.02 --hidden 64 --vs_ratio 0.001 --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 160 --attack_method 'Basic' --defense_mode 'none' --homo_loss_weight 1 --dis_weight 1 --selection_method 'none' --device_id 1 > ./logs/Arxiv/Arxiv_Unno_None_gcn2gcn_vs160.log 2>&1 &
