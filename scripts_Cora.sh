...
# Defend: None
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'none' --trojan_epochs 400 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.3 --dis_weight -1 --selection_method 'cluster_degree' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Ours_None_gcn2gcn_clu_vs10_1.log 2>&1 &
# Defend: Prune
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'none' --trojan_epochs 400 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.4 --dis_weight -1 --selection_method 'cluster_degree' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Ours_None_gcn2gcn_clu_vs10.log 2>&1 &
# Defend: Isolate
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'isolate' --trojan_epochs 2000 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.5 --dis_weight 0 --selection_method 'cluster_degree' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Ours_Isolate_gcn2gcn_clu_vs10.log 2>&1 &
# Attack: Variance Without Selection
# Defend: None
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'none' --trojan_epochs 400 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.5 --dis_weight 1 --selection_method 'none' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Unno_None_gcn2gcn_clu_vs10.log 2>&1 &
# Defend: Prune
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'prune' --trojan_epochs 400 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.5 --dis_weight 1 --selection_method 'none' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Unno_Prune_gcn2gcn_clu_vs10.log 2>&1 &
# Defend: Isolate
nohup python -u run_adaptive.py --dataset 'Cora' --model 'GCN' --test_model 'GCN' --use_vs_number --vs_number 10 --attack_method 'Basic' --defense_mode 'isolate' --trojan_epochs 400 --prune_thr 0.1 --homo_loss_weight 100 --homo_boost_thrd 0.5 --dis_weight 1 --selection_method 'none' --device_id 2 --evaluate_mode '1by1' > ./logs/Cora/Cora_Unno_Isolate_gcn2gcn_clu_vs10.log 2>&1 &
